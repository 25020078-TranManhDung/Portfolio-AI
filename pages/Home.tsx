...
export default function Home() {
  ...
  useEffect(() => {
    ...
    timeout = setTimeout(type, 1500); // Start after Name finishes
  ...
  return (
    <div className="flex flex-col gap-16">
      ...
      <motion.section 
        ...
        initial="hidden"
        animate="show"
        className="flex flex-col-reverse md:flex-row items-center gap-10 pt-12"
      >
        <motion.div 
          variants={item}
        ...
        >
          ...
          <div className="h-[2em] sm:h-[1.5em] text-xl sm:text-2xl font-semibold text-muted-foreground flex items-center">
            <span className="text-white">{typedTitle}</span>
            <span className="ml-1 inline-block w-[3px] h-[1em] bg-primary rounded-full animate-[pulse_1s_ease-in-out_infinite]"></span>
          </div>
        ...
        >
          ...
          <div className="relative w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 rounded-full p-[4px] overflow-hidden flex items-center justify-center" style={{ WebkitMaskImage: '-webkit-radial-gradient(white, black)' }}>
      ...
      <motion.section 
        ...
        className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8 overflow-hidden"
      >
        <motion.div 
          variants={item}
        ...
        >
          ...
          <ul className="text-muted-foreground space-y-2 mt-2 list-disc list-inside">
            ...
            <li>Sở thích: Lập trình, thiết kế UI/UX, tìm hiểu AI, xem anime.</li>
