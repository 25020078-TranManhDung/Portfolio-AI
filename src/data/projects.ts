...
export const projects = [
  {
    ...
    results: [
      ...
      {
        image: "/bai1-anh2.png",
        caption: "Tạo mới một tệp văn bản (.txt)",
        aspectRatio: "aspect-[3/2]"
      },
      {
        image: "/bai1-anh3.png",
        caption: "Thực hiện sao chép (Copy & Paste) và di chuyển (Cut & Paste)",
        aspectRatio: "aspect-[3/2]"
      },
      {
        image: "/bai1-anh4.png",
        caption: "Thực hành xóa tệp tin vào Thùng rác (Delete)",
        aspectRatio: "aspect-[3/2]"
      },
      {
        image: "/bai1-anh5.png",
        caption: "Cấu Trúc Thư Mục Đã Tạo",
        aspectRatio: "aspect-[3/2]"
      }
    ]
  },
  {
    ...
    results: [
      ...
      {
        image: "/bai2-anh2.png",
        caption: "Tiến hành đánh giá chuyên sâu",
    ...
    resultRows: [
      {
        cols: 2,
        items: [
          { image: "/bai3-anh1.png", caption: "Chọn tác vụ học tập", aspectRatio: "aspect-[16/9]" },
          { image: "/bai3-anh2.png", caption: "Thiết kế 3 phiên bản Prompt", aspectRatio: "aspect-[16/9]" }
        ]
      },
      {
        cols: 3,
        items: [
          { image: "/bai3-anh3.png", caption: "Thử nghiệm trực tiếp với ChatGPT (Prompt cơ bản)", aspectRatio: "aspect-[4/3]" },
          { image: "/bai3-anh4.png", caption: "Thử nghiệm trực tiếp với ChatGPT (Prompt cải tiến)", aspectRatio: "aspect-[4/3]" },
          { image: "/bai3-anh5.png", caption: "Thử nghiệm trực tiếp với ChatGPT (Prompt nâng cao)", aspectRatio: "aspect-[4/3]" }
        ]
      },
      {
        cols: 1,
  ...
  },
  {
    ...
    results: [
      {
        image: "/bai4-anh1.png",
        caption: "Phân công vai trò cụ thể",
        aspectRatio: "aspect-[8/7]"
      },
      {
        image: "/bai4-anh2.png",
        caption: "Tích hợp và sử dụng nâng cao Trello để quản lý dự án",
        aspectRatio: "aspect-video"
      },
      {
        image: "/bai4-anh3.png",
        caption: "Sử dụng Google Drive để lưu trữ và chia sẻ file",
        aspectRatio: "aspect-video"
      }
    ]
  },
    ...
    resultRows: [
      {
        cols: 2,
        items: [
          { image: "/bai5-anh1.png", caption: "Lựa chọn dự án sáng tạo", aspectRatio: "aspect-[4/3]", objectFit: "contain" },
          { image: "/bai5-anh2.png", caption: "Lựa chọn bộ công cụ AI", aspectRatio: "aspect-[4/3]", objectFit: "contain" }
        ]
      },
      {
        cols: 1,
        items: [
          { image: "/bai5-anh3.png", caption: "Triển khai với Prompt Engineering", aspectRatio: "aspect-[4/3]", objectFit: "contain" }
        ]
      },
      {
        cols: 1,
        items: [
          { image: "/bai5-anh4.png", caption: "Sản phẩm cuối cùng – Infographic '5 Khái Niệm Toán Học cho Data Science'", aspectRatio: "aspect-video", objectFit: "contain" }
        ]
      }
    ],
    results: []
    ...
    resultRows: [
      {
        cols: 2,
        items: [
          { image: "/bai6-anh1.png", caption: "Nghiên cứu chính sách", aspectRatio: "aspect-[3/2]" },
          { image: "/bai6-anh2.png", caption: "Thực hành AI vào chủ đề Giải tích 1", aspectRatio: "aspect-[3/2]" }
        ]
      },
      {
        cols: 2,
        items: [
          { image: "/bai6-anh3.png", caption: "Phân tích sâu sắc các vấn đề đạo đức", aspectRatio: "aspect-[3/2]" },
          { image: "/bai6-anh4.png", caption: "Đúc kết Bộ nguyên tắc cá nhân", aspectRatio: "aspect-[3/2]" }
        ]
      },
      {
        cols: 1,
        items: [
          { image: "/bai6-anh5.png", caption: "Sản phẩm cuối cùng – Bộ nguyên tắc cá nhân về sử dụng AI có trách nhiệm", aspectRatio: "aspect-[3/4]" }
        ]
      }
    ],
    results: []
