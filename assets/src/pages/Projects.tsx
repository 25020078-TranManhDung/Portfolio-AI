                      ...
                      >
                        ...
                        <div className="flex flex-col gap-3">
                          {project.results && project.results.length > 0 && (
                            <div className={`mb-4 w-full ${project.results.length === 1 ? 'max-w-3xl mx-auto' : project.results.length === 2 ? 'grid grid-cols-1 md:grid-cols-2 gap-4' : 'grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4'}`}>
                              {project.results.map((result, rIdx) => (
                                <div key={rIdx} className="flex flex-col justify-between h-full gap-2 relative group rounded-xl overflow-hidden border border-white/10 bg-background/50 p-2">
